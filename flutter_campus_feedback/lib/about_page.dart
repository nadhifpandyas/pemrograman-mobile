          ...
          child: Card(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  // Logo universitas lokal (assets)
                  // Pastikan file assets/uin_logo.png ada dan didaftarkan di pubspec.yaml
                  SizedBox(
                    width: 120,
                    height: 120,
                    child: Image.asset('assets/uin_logo.png', fit: BoxFit.contain),
                  ),
